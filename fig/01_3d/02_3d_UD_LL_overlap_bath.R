...
for (l in 1:nlayers(rstack)) {
  ...
  # for avoid fill holes extremely in one of the layer for this organismID
...
# export / save diorama 
# render snapshot
render_snapshot(filename = paste0(output_dir, "/fig/fig_LL_UD50_overlap_3d_v2.png"))
...
# export / save diorama 
# render snapshot
render_snapshot(filename = paste0(output_dir, "/fig/sup_fig_LL_UD50_overlap_3d_lowcam_90_v2.png"))
...
# export / save diorama 
# render snapshot
render_snapshot(filename = paste0(output_dir, "/fig/sup_fig_LL_UD50_overlap_3d_lowcam_270_v2.png"))
...
# export / save diorama --------------------------------------------------------
# render snapshot
render_snapshot(filename = paste0(output_dir, "/fig/sup_fig_LL_UD50_overlap_3d_cenital_v2.png"))
...
# export / save diorama 
# render snapshot
render_snapshot(filename = paste0(output_dir, "/fig/fig_LL_UD95_overlap_3d.png"))
